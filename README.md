...
3.	Using a publicly available software, [Berkely Aligner](https://github.com/mhajiloo/berkeleyaligner), to map the text to Strong’s number. The process is not perfect, but has around 75% accuracy (which can vary between languages). 
